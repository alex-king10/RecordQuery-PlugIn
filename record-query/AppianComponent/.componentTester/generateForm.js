...
componentDescriptor = [{"name":["tasks"],"category":["input-only"],"type":["Text?list"]},{"name":["onComplete"],"category":["event"]},{"name":["onDelete"],"category":["event"]},{"name":["connectedSystem"],"category":["input-only"],"type":["ConnectedSystem"]}];
var defaultValues = {"tasks":[["sd"],["Ddsfa"]],"onComplete":[null]};
